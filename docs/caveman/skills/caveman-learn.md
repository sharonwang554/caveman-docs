...
- Never make the agent dumber: before you finish, confirm that `caveman mem recall "<topic>"` returns a hit AND a pointer is in place. If recall returns nothing, or you
